...
export default function StaffDefenseScheduleDetailsPage() {
    ...
    const resolvedCreator = schedule?.created_by_name || schedule?.created_by_email || "System"

    return (
        <DashboardLayout
            title="Defense Schedule Details"
            description="View complete defense schedule information for staff operations."
        >
            <div className="space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                    <Button asChild variant="outline" size="sm">
                        <Link href="/dashboard/staff/defense-schedules">Back to Schedules</Link>
                    </Button>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <Card className="shadow-sm">
                                <CardHeader className="pb-2">
                                    <CardDescription>Owner &amp; Audit</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-1 text-sm">
                                    <p className="text-muted-foreground">Created by: {resolvedCreator}</p>
