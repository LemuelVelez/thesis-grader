...
export default function AdminSettingsPage() {
    ...
    // ✅ now includes global avatarUrl + refreshAvatarUrl + refresh
    ...
    async function saveProfile(e: React.FormEvent) {
        ...
        try {
            ...
            // refresh global auth user + keep avatar state consistent
            await refresh()
    ...
    async function uploadAvatar(file: File) {
        ...
        try {
            ...
            // ✅ refresh global user + global avatar URL cache
            await refresh()
            await refreshAvatarUrl()
            router.refresh()
        } catch {
    ...
    async function removeAvatar() {
        ...
        try {
            ...
            // ✅ refresh global user + global avatar URL cache (clears it)
            await refresh()
            await refreshAvatarUrl()
            router.refresh()
        } catch {
                        ...
                        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Update your account information, avatar, and password.
                                </p>
                            </div>
                                        ...
                                        <TabsContent value="avatar" className="space-y-4">
                                            ...
                                            <Accordion type="single" collapsible>
                                                <AccordionItem value="help-avatar">
                                                    ...
                                                    <AccordionContent className="text-sm text-muted-foreground">
                                                        The app uses a presigned URL for secure direct uploads. After upload, the server stores the image key in your user profile.
                                                    </AccordionContent>
                                                </AccordionItem>
                                            </Accordion>
                                        </TabsContent>
