...
export default async function Page({ searchParams }: { searchParams: SearchParams }) {
  ...
  `
    ...
    const prevHref =
        page > 1 ? buildHref(baseHref, { q: q || undefined, page: String(page - 1), limit: String(limit) }) : null
    const nextHref =
        page < totalPages ? buildHref(baseHref, { q: q || undefined, page: String(page + 1), limit: String(limit) }) : null
