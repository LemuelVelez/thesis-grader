...
import { Camera, Check, Copy, Info, KeyRound, Loader2, Trash2, Upload, User2, Users } from "lucide-react"
                    ...
                    <div className="space-y-2">
                        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                            <div className="space-y-1">
                                <h1 className="text-xl font-semibold tracking-tight">Student Settings</h1>
                    ...
                    <AlertDialog open={removeAvatarOpen} onOpenChange={setRemoveAvatarOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>This will remove your current profile photo. You can upload a new one anytime.</AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
