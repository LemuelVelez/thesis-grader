...
export async function GET(_req: NextRequest, ctx: RouteContext) {
    try {
        ...
        const data = await (DefenseSchedulesController.getById as any)(id)
        return NextResponse.json(data)
    } catch (err: any) {
        return errorJson(err, "Failed to get defense schedule")
    }
}
...
export async function PUT(req: NextRequest, ctx: RouteContext) {
    try {
        ...
        const data = await callUpdate(DefenseSchedulesController.update as any, id, body)
        return NextResponse.json(data)
    } catch (err: any) {
        return errorJson(err, "Failed to update defense schedule")
    }
}
...
export async function DELETE(_req: NextRequest, ctx: RouteContext) {
    try {
        ...
        const data = await (DefenseSchedulesController.delete as any)(id)
        return NextResponse.json(data ?? { ok: true })
    } catch (err: any) {
        return errorJson(err, "Failed to delete defense schedule")
    }
}
