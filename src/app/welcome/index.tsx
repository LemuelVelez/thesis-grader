  ...
  return (
    <main className="relative min-h-dvh w-full bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/70 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        >
          {/* Logo: smooth behavior, no black splash */}
          <Link
            to="/"
            onClick={(e) => {
              if (location.pathname === "/welcome") {
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Button asChild>
              <Link to="/auth" style={{ WebkitTapHighlightColor: "transparent" }}>
                Login
              </Link>
            </Button>
          </div>
        ...
        {/* Mobile top slide-down panel (from the top) */}
        <div
          id="mobile-menu"
          className={`md:hidden overflow-hidden border-b bg-background transition-[max-height,opacity,transform] duration-300 ease-in-out ${
      ...
      {/* HERO — vertical stack on mobile, side-by-side on large screens */}
      <section
        className="
      ...
      >
        ...
        <div className="order-1 flex w-full max-w-xl flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
          {/* Removed the 'Capstone • September 2025' badge per request */}
        ...
        <div className="order-2 grid w-full max-w-xl content-center gap-4 justify-self-center lg:order-2">
          <Card className="backdrop-blur">
            ...
            {/* Vertical on mobile, 3-up on larger screens */}
